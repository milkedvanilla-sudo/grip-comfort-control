    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          className="font-body text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10">Premium firearm grips engineered for superior comfort, reduced recoil, and total control.
